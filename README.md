...
- نسخهٔ پیش‌نمایش وب (`web/index.html`) هم برای ثبت‌نام/ورود، کامیون‌ها و دعوت راننده به یک دیتابیس واقعی وصل شده (جزئیات در `web/README.md`)؛ صفحات سرویس/هزینه/تسویهٔ همان پیش‌نمایش هنوز محلی (Mock) مانده‌اند.
